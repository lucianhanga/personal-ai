...
async def run_turn(
    *,
    ...
    agent_reasoning: Mapping[str, str] | None = None,
    agent_models: Mapping[str, str] | None = None,
    agent_disabled_tools: Mapping[str, Sequence[str]] | None = None,
    ...
    if use_tools:
        ...
        if graph_enabled:
            agent_events = run_graph(
                ...
                reasoning_levels=agent_reasoning,
                model_overrides=agent_models,
