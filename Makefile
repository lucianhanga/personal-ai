...
typecheck: ## mypy type check (Python)
	uv run mypy contracts core apps/backend providers/ollama providers/openai_compat providers/whisper_local storage/postgres modalities/files tools/builtin tools/mcp
